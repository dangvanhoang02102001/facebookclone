...
export const publicRoutes = [
    ...
    { path: '/profile/:id/about', component: ProfileIntro, layout: 'profile' },
    { path: '/profile/:id/friends', component: ProfileFriend, layout: 'profile' },
    { path: '/profile/:id/photos', component: ProfilePhoto, layout: 'profile' },
    { path: '/post/:id', component: PostDetail, layout: null },
    ...
    { path: '/groups/:id', component: GroupPostDetail, layout: 'default' },
