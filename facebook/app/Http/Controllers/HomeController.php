...
class HomeController extends Controller
{
    ...
    public function index() {
        ...
        $myposts = Post::with('postsCreated','user','comments','reaction')
        ...
        // $post = Post::where('user_id', $friend)->get('id')->toArray();
        // dd($post);
    // 'createPostdetail',
        $posts = Post::with('postsCreated','user','comments','reaction')
    ...
    public function listStories()
    {
        ...
        // $friend_id = $friends->map(function ($friend_id) {
        //     $friend_id = $friend_id;    
        //     return $friend_id;
        // });
