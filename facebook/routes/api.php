...
Route::group([
    ...
    Route::post('/stories', [HomeController::class, 'createStories'])->name('createStories');
    // Route::post('/stories_img', [HomeController::class, 'createStoriesImg'])->name('createStoriesImg');
    Route::delete('/stories/{id}', [HomeController::class, 'deleteStories'])->name('deleteStoriesText');
    ...
    Route::get('/friendList', [FriendController::class,'friendList'])->name('listFriend');
